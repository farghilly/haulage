...
with tab_fleet:
    ...
    with col1:
        ...
        st.metric(label="Total Dead Head Distance", value=round(filtered_df['dead_head_distance'].sum(), 2))
    ...
    with col2:
        ...
        st.metric(label="Total Distance Travelled", value=round(filtered_df['total_distance'].sum(), 2))
